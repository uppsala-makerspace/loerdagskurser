...
=== "🇸🇪"
    ...
    3D modellerna används för
    [3D skrivningskursen](om_3d_skrivningskursen.md).

=== "🇬🇧"

    During this course we will learn how to create 3D models in OpenSCAD.
    We can use the models for
    [the 3D printing course](om_3d_skrivningskursen.md).

![Programming with OpenSCAD bok](programming_with_openscad_book_cover.jpg)

=== "🇸🇪"

    Kursen använder boken 'Programmering med OpenSCAD',
...
=== "🇬🇧"
    ...
    The course uses the book 'Programming with OpenSCAD',
