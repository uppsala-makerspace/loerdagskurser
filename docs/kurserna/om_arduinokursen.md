# 🇸🇪 Om Arduinokursen 🇬🇧 About the Arduino course

=== "🇸🇪"

    Arduinokursen är en av [kurserna](README.md) som utgör
...
=== "🇸🇪"
    ...
    fär att skapa dina egna, riktiga maskiner.
...
=== "🇬🇧"
    ...
    Later in the course, you will do [the soldering course](om_loedningskursen.md)
