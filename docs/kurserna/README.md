...
=== "🇸🇪"
    ...
    Dessa är kurserna vi lär ut under Lördagsurserna:
    ...
    ![Blender logo](blender_community_badge_white_39_x_32.png) **Blender**                               |10:00-12:00|Ett 3D ritnings program för att, t.ex. 3D skrivning                      | [Grundkurs i Blender](https://github.com/richelbilderbeek/grundkurs_i_blender)
    ...
    Varje tillfälle du deltar får du välja en av kurserna för det tillfället.
